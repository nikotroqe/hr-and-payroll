...
public class OvertimeServiceImpl implements OvertimeService {
    ...
    @Override
    public Page<Overtime> getAllOvertime1(Map<String, Object> filterRequest, Integer page, Integer size, String sort) {
    ...
    public Overtime rejectOvertime(Integer overtimeId) {
        Overtime overtime = overtimeRepository.findById(overtimeId)
                .orElseThrow(() -> new RuntimeException("Overtime not found"));
